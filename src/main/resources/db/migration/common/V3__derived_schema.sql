...
(
    bin_day_features_key                BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    estimated_fill_addition_per_day     NUMERIC(8, 4),
    good_weather_sensitivity_score      NUMERIC(8, 4),
    bad_weather_sensitivity_score       NUMERIC(8, 4),
...
(
    system_day_summary_key     BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
