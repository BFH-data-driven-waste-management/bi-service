...
(
    zone_key  BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    bin_key       BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    tour_key                BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    bin_visit_key           BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    vehicle_emptying_key   BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    tour_id                BIGINT      NOT NULL,
    sequence_in_tour       INTEGER     NOT NULL CHECK (sequence_in_tour >= 1),
    event_ts               TIMESTAMPTZ NOT NULL,
    date_key               INTEGER     NOT NULL,
...
(
    bin_daily_snapshot_key       BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    date_key                     INTEGER NOT NULL,
    bin_key                      BIGINT  NOT NULL,
    zone_key                     BIGINT,
...
(
    bin_status_change_key BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    weather_day_key         BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
(
    event_zone_day_key BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
